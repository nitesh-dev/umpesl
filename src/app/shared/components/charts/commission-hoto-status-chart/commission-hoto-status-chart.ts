...
@Component({
  selector: 'app-commission-hoto-status-chart',
  imports: [CommonModule, BaseChartDirective],
  templateUrl: './commission-hoto-status-chart.html',
  styleUrl: './commission-hoto-status-chart.scss'
})
export class CommissionHotoStatusChart {
